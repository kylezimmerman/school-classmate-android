...
public class RegisterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            LogHelper.logError(this, "RegisterActivity", "Error creating the Register Activity", ex.getMessage());
        }
    }
            ...
            user.signUpInBackground(new SignUpCallback() {
                ...
                public void done(ParseException e) {
                    try {
                        ...
                        LogHelper.logError(RegisterActivity.this, "RegisterActivity",
                                "Error logging in, please try again", ex.getMessage());
                    }
                }
            });
        } catch (Exception ex) {
            LogHelper.logError(this, "RegisterActivity", "Error registering, please try again", ex.getMessage());
        }
    }
}
